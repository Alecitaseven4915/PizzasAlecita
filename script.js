document.addEventListener("DOMContentLoaded", function () {
    // Validar horario de la pizzería
    let ahora = new Date();
    ...
    if (document.getElementById("Index-form")) {
        ...
        document.getElementById("calcular-total").addEventListener("click", function (event) {
            ...
            // Mostrar total y habilitar botón "Siguiente"
    ...
    if (document.getElementById("pagoss-form")) {
        ...
        let saldoTarjeta = Math.floor(Math.random() * 1000) + 100; // Simula saldo aleatorio
